...
const Cart = () => {
    ...
    const { products, currency, axios, user, cartItems, removeFromCart, getCartCount, updateCartItem, navigate, getCartAmount, setCartItems } = useAppContext()
    ...
    const getCart = () => {
        ...
        for (const key in cartItems) {
            ...
            //          if (product) { // ✅ Guard against undefined
            //   product.quantity = cartItems[key];
            //   tempArray.push(product);
            // }
        }
    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <select onChange={e => updateCartItem(product._id, Number(e.target.value))} value={cartItems[product._id]} className='outline-none'>
                                            ...
                                            {Array.from(
                                                { length: Math.max(9, cartItems[product._id] ?? 1) }, // ✅ Always >= 9
                                                (_, index) => (
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {!showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate('/add-address')} className="text-green-500/80  text-center cursor-pointer p-2 hover:bg-green-500/10">
                                    Add address
                                </p>
                            </div>
                        )}
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-green-500/80 text-white font-medium hover:bg-green-600/90 transition">
